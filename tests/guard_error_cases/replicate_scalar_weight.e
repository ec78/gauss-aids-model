...
** scalar nonzero base/full-sample weight via quaidsFit()'s shared contract.
*/
...
rOut = quaidsReplicateWeightFit(w, intcpt, prices, totexp, instr, aCtl, ones(tobs, 3), 1, weight=1);
