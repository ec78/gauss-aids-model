...
** replicateWeights matrix whose row count does not match the sample.
*/
...
rOut = quaidsReplicateWeightFit(w, intcpt, prices, totexp, instr, aCtl, ones(tobs-1, 5), 0.8, method="JK1");
